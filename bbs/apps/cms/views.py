...
def cusers():
    cuser = CMSUser.query.all()
    print(cuser[0].roles[0].name)
...
@bp.route('/uptoken/')
def uptoken():
    access_key = '4pMtV3F2eWZWv0TSD3DXjhcmlmVpxOCLvIdM8aF7'
    secret_key = 'GsmHmllZkpxOh5VAkzGrSSjCL7MQGZraQhtYmE-O'
    q = qiniu.Auth(access_key,secret_key)

    bucket = 'flask-1903bbs'
...
@bp.route('/ucomment/', methods=['POST'])
@login_required
@permission_required(CMSPersmission.COMMENTER)
def ucomment():
